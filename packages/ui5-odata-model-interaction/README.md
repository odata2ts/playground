...
This app demonstrates the usage of [odata2ts](https://odata2ts.github.io/)
...
In this example `odata2ts` is responsible for:
* generating types for the data model of the OData server
* generating query objects which offer certain features
